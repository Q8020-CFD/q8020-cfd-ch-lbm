...
fixed quantum circuit. The circuit realizes the heat propagator in its
eigenbasis with a single block-encoding ancilla per step. We do not concede the phase problem, and we do not require a classical solution to be computed simultaneously to
