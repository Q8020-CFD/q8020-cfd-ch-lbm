...
Usage:
    ./.venv/bin/python tmp/check_ibm_conn.py
    ./.venv/bin/python tmp/check_ibm_conn.py --backend-name ibm_boston
    ./.venv/bin/python tmp/check_ibm_conn.py --instance <CRN> --token <KEY>
"""
...
def main() -> int:
    ...
    if args.backend_name:
        try:
            b = service.backend(args.backend_name)
            status = b.status()
